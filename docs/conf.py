# -*- coding: utf-8 -*-
#
# python-rtkit documentation build configuration file, created by
...
html_theme = 'agogo' #'haiku' #'agogo' #'pyramid' #'nature' #'default'
...
html_title = "python-rtkit %s" % VERSION
...
htmlhelp_basename = 'python-rtkitdoc'
